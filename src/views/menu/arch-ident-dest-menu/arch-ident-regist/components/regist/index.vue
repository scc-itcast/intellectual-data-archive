              ...
              >
                ...
                >
                  ...
                  <el-table-column
                    ...
                    width="200"
                  ></el-table-column>
                  <el-table-column label="案卷档号" prop="books_no" width="100"></el-table-column>
                  <el-table-column
                    label="存放位置"
                    prop="stor_location"
                    width="100"
                  ...
                  <el-table-column
                    ...
                    width="120"
                  ></el-table-column>
                  <el-table-column label="密级" prop="security_class" width="120"></el-table-column>
                  <el-table-column label="新保管期限" width="100">
                    <template slot-scope="scope">
                      <span>
                        <el-select
                          :value="scope.row.new_safe_duration"
                          @change="fun_input_handle(scope.row, $event, 'use_type')"
                        >
                          <el-option
                            v-for="(item, index) in safe_duration_list"
                            :key="index"
                            :label="item.label"
                            :value="item.prop"
                          >
                  ...
                  <el-table-column label="新密级" width="100">
                    <template slot-scope="scope">
                      <span>
                        <el-select
                          :value="scope.row.new_security_class"
                          @change="fun_input_handle(scope.row, $event, 'use_type')"
                        >
                          <el-option
                            v-for="(item, index) in security_class_list"
                            :key="index"
                            :label="item.label"
                            :value="item.prop"
                          >
                  ...
                  <el-table-column label="是否销毁" width="100">
                    <template slot-scope="scope">
                      <span>
                        <el-select
                          :value="scope.row.arch_dest"
                          @change="fun_input_handle(scope.row, $event, 'use_type')"
                        >
                          <el-option
                            v-for="(item, index) in arch_dest_list"
                            :key="index"
                            :label="item.label"
                            :value="item.prop"
                          >
                  ...
                  <el-table-column label="操作" width="100">
                    <template slot-scope="scope">
                      <span>
                        <el-button type="text" @click="fun_delete_case(scope.row, scope.$index)">
                          删除
                        </el-button>
                        <el-button type="text" @click="fun_look_project(scope.row, scope.$index)">
                          查看
                        </el-button>
                      </span>
                    </template>
  ...
  setup(prop, context) {
    let table_case_list = reactive({
      ...
      thead: [
        ...
        { label: '存放位置', prop: 'stor_location', checked: true, width: '200' },
        { label: '归档时间', prop: 'archive_date', checked: true, width: '200' },
        { label: '保管期限', prop: 'safe_duration', checked: true, width: '200' },
        { label: '密级', prop: 'security_class', checked: true, width: '200' },
        { label: '新保管期限', prop: 'new_safe_duration', checked: true, width: '200' },
        { label: '新密级', prop: 'new_security_class', checked: true, width: '200' },
        { label: '是否销毁', prop: 'arch_dest', checked: true, width: '200' },
        {
          label: '操作',
          prop: 'operation',
          checked: true,
