    ...
    <template slot="header">
      <div class="query--box global--flex">
        ...
        <div class="query-btn--box global--flex">
          ...
          <sz-button class="global--ml10" title="列表视图" @click="fun_view_toggle"></sz-button>
...
export default {
  ...
  setup(prop, context) {
    ...
    onMounted(async () => {
      ...
      const case_file_tree_item = contextData.case_file_tree_item
      contextData.case_file_tree_item = { ...tree_list, ...case_file_tree_item }
    ...
    const fun_modifi_num_close = obj => {
      ...
      if (obj) {
        ...
        const file_generic_table_index = contextData.file_generic_table_index
        let list_checked = []
        for (const key in modifi_num_from_checked) {
          if (modifi_num_from_checked[key]) {
            list_checked.push(key)
          }
        }
