<template>
  <d2-container type="card" better-scroll :breadcrumb="breadcrumb">
    <template>
      <!-- <book></book> -->
      <sz-case-file-level :tree_item="tree_item" />
    </template>
  </d2-container>
</template>
...
import Book from '@/views/menu/file-bgf-menu/inven-file-modi/components/book/index.vue'
export default {
  name: 'book-manage',
  components: {
    Book
  ...
  setup(prop, context) {
    let contextData = reactive({
      ...
      breadcrumb: [
        ...
        { path: '/file-bgf/inven-file-modi/book-manage/modify-book', title: ' 修改案卷信息' },
      ],
      tree_item: {
        id: '',
        type: '',
