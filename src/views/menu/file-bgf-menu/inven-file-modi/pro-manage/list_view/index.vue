...
export default {
  ...
  setup(prop, context) {
    let tableList = reactive({
      ...
      thead: [
        { label: '项目档号', prop: 'pro_file_num', checked: true, width: '200' },
        { label: '项目名称', prop: 'project_name', checked: true, width: '200' },
    ...
    const fun_modify_project = row => {
      context.root.$router.push({
        path: '/file-bgf/inven-file-modi/pro-manage/modify-project',
        query: {
          id: row.id,
