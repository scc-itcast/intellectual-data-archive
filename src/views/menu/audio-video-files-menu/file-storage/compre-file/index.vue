  ...
  setup(prop, context) {
    ...
    let contextData = reactive({
      ...
      { path: '/audio-video-files', title: '声像档案' },
        { path: '/audio-video-files/file-storage/compre-file', title: '档案入库' },
        { path: '/audio-video-files/file-storage/compre-file', title: '综合档案' }
      ],
      queryList: {
      ...
      button_list: {
        ...
        generate_no: { title: '生成档号', value: '' },
        into_library: { title: '入库', value: '' },
        play_back: { title: '打回', value: '' },
        pic_simil_analy: { title: '图片相似度分析', value: '' }
      },
      button_list_copy: {},
      button_list_all: {
        modify_engine: {
    ...
    const fun_tree_click = (val, index) => {
      switch (index) {
        ...
        case 'pic_simil_analy': {
          contextData.button_list_copy = {}
          Object.assign(contextData.button_list_copy, contextData.button_list)
          contextData.button_list = contextData.button_list_all.pic_simil_analy
          fun_tree_item_flag('analy')
          break
        }
        default: {
        }
