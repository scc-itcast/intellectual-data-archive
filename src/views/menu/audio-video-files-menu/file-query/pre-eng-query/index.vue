...
import LookProject from '@/views/menu/audio-video-files-menu/file-query/pre-eng-query/components/look_project.vue'
export default {
  name: 'pre-eng-query',
  components: {
    LookProject
  ...
  setup(prop, context) {
    ...
    let contextData = reactive({
      ...
      breadcrumb: [
        ...
        { path: '/audio-video-files/file-query/pre-eng-query', title: '档案查询' },
        { path: '/audio-video-files/file-query/pre-eng-query', title: '综合工程查询' }
      ],
      queryList: {
        engin_name: { title: '工程名称', value: '' },
        engin_adress: { title: '工程地点', value: '' }
      },
      advanced_query_obj: {
