  ...
  setup(prop, context) {
    ...
    let contextData = reactive({
      ...
      breadcrumb: [
        ...
        { path: '/audio-video-files/svafile-modifi/pre-file-manage', title: '库存声像档案修改' },
        { path: '/audio-video-files/svafile-modifi/pre-file-manage', title: '综合档案管理' }
      ],
      queryList: {
