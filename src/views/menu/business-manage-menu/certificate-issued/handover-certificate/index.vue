...
import ModifiNum from '@/views/menu/business-manage-menu/certificate-issued/components/modifi_num.vue'
export default {
  ...
  setup(prop, context) {
    let tableList = reactive({
      ...
      children_thead: [
        ...
        { label: '编号', prop: 'unique_ident', checked: true, width: '200' },
        ...
        { label: '发证日期', prop: 'certificate_date', checked: true, width: '150' },
        {
          ...
          buttonGroup: [
            ...
            },
            {
              ...
              type: 'text',
              event: 'button',
              handler: data => fun_serial_handover(data)
            }
          ]
        }
      ],
    ...
    let contextData = reactive({
      ...
      breadcrumb: [
        ...
        { path: '/business-manage/certificate-issued/handover-certificate', title: '证件发放' },
    ...
    const fun_create_handover = row => {
      context.root.$router.push({
        path: '/business-manage/certificate-issued/handover-certificate/increase-certificate',
        query: {
          id: row.id,
          type: row.project_type
        }
    ...
    const fun_modify_handover = row => {
      context.root.$router.push({
        path: '/business-manage/certificate-issued/handover-certificate/modify-certificate',
        query: {
          id: row.id,
          type: row.project_type
        }
