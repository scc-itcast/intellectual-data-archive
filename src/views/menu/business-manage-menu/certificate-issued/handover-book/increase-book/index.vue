...
import Book from '@/views/menu/business-manage-menu/certificate-issued/components/book/index.vue'
export default {
  name: 'increase-book',
  components: {
    Book
  ...
  setup(prop, context) {
    let contextData = reactive({
      ...
      breadcrumb: [
        ...
        { path: '/business-manage/certificate-issued/handover-book/increase-book', title: '添加移交书' }
      ]
    })
    onMounted(async () => {
      // 调用方法, 方法里调用接口
