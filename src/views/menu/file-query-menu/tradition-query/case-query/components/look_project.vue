    ...
    >
      ...
      <div class="global--plr40">
        <el-tabs v-model="active_name" @tab-click="fun_tab_click">
          ...
          <el-tab-pane label="利用记录" name="audio_video_group_info">
            <div class="look-project-dialog-body--table">
              <div class="look-project-dialog-body--search">
                <el-input
                  placeholder="请输入内容"
                  v-model="audio_video_input"
                  class="input-with-select"
                >
                  <el-button
                    slot="append"
              ...
              <sz-table :config="use_records_info_list"></sz-table>
            </div>
          </el-tab-pane>
        </el-tabs>
      </div>
...
export default {
  ...
  setup(prop, context) {
    ...
    let use_records_info_list = reactive({
      search_form: false,
      isRequest: false,
      pagination: true,
      // checkbox: true,
      number: false,
      expand_info_look: true,
      component_info_look: 'UseRecords',
      table_height: 472,
      url: '',
      data: {
        pageIndex: 1,
    ...
    const fun_look_project_zoom = () => {
      ...
      use_records_info_list.table_height = 472
      if (contextData.fullscreen) {
        ...
        use_records_info_list.table_height = document.body.clientHeight - 600
      }
    }
    ...
    return {
      ...
      use_records_info_list,
      ...toRefs(use_records_info_list),
